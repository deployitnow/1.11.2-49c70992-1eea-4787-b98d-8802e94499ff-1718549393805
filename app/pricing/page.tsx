...
export default function PricingPage() {
  ...
  const bannerText = 'Sign up early for a massive beta discount (Limited time offer)';
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col items-center">
          <div className="w-full lg:w-auto mx-auto max-w-4xl lg:text-center">
            ...
            <p className="mt-6 md:text-xl lg:text-center max-w-prose">
              We have searched far and wide. You will never find anything like Spider AI.
            </p>
          </div>
